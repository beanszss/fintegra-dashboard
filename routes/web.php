...
// Route::post('login', [AuthController::class, 'attempts'])->name('login');
// Route::post()
...
//     // Route Dashboards
//   Route::get('dashboard-analytics', [DashboardController::class, 'dashboardAnalytics'])->name('dashboard-home');
//   Route::get('/dashboard-ecommerce', 'DashboardController@dashboardEcommerce');
